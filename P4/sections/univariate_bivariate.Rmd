...
knitr::kable(
  dplyr::summarise(group, median=median(fixed.acidity), '75%'=quantile(fixed.acidity, 0.75))
)
```
...
```
Again very standard distribution. But a outlier might have caused some problem.
...
No, things look still pretty normally distributed.
